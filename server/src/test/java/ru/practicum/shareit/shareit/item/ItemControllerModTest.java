...
import ru.practicum.shareit.shareit.request.ItemRequestController;
...
class ItemControllerModTest {
    ...
    void createCommentTest() {
        ...
        ItemDto.BookingForItemDto booking = new ItemDto.BookingForItemDto(0L,
                ...
                LocalDateTime.now().plusDays(7), user.getId());
        booking.setId(1L);
        UserDto user2 = userController.create(new UserDto(0L, "name", "email2@email.com"));
