...
class ItemRequestControllerTest {
   ...
   /* @Test
    void getItemRequestsOwnerSorted() {
        ...
        assertEquals(1, Objects.requireNonNull(itemRequestController.getItemRequestsOwnerSorted(
                userDto1.getId(), 0, 5).getBody()).size());
    }*/
    ...
    void getItemRequestsOtherSorted() {
        ...
        UserDto userDto2 = userController.create(new UserDto(0, "new_user_name", "new@email.com")).getBody();
        assert userDto2 != null;
        assertEquals(1, Objects.requireNonNull(itemRequestController.getItemRequestsOtherSorted(
                userDto2.getId(), 0, 5).getBody()).size());
    }
