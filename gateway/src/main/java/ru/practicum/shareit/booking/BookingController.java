...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<Object> addBooking(@Positive @RequestHeader("X-Sharer-User-Id") Long ownerId,
    ...
    public ResponseEntity<Map<String, String>> errorHandler(IllegalArgumentException ex) {
        ...
        response.put("error", String.format("Unknown state: UNSUPPORTED_STATUS"));
